...
RSpec.describe Whiistles::FloodInfoComponent, type: :component do
  before(:each) do
    FactoryBot.reload
  end
  ...
  context 'if a whiistle has a flood' do
    it "renders 'Show this thread' link " do
      ...
      expect(rendered_content).to match_snapshot('FloodInfoComponent_with_whiistle')  
  ...
  context 'if a whiistle is a Flood' do
    it "renders 'Show this thread' link " do
      ...
      expect(rendered_content).to match_snapshot('FloodInfoComponent_with_whiistle_as_Flood')  
      expect(rendered_content).to include "Show this thread"
    end
  end
end
