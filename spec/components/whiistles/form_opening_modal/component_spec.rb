...
RSpec.describe Whiistles::FormOpeningModal::Component, type: :component do
  context "if value is given" do
    it "renders correctly" do
      ...
      expect(rendered_content).to include "Whiistles::FormBody::Component(form: SimpleForm::FormBuilder, label: String, value: String, open_modal: TrueClass, path: String)"
  ...
  context "if value is given" do
    it "renders correctly" do
      ...
      expect(rendered_content).to include "Whiistles::FormBody::Component(form: SimpleForm::FormBuilder, label: String, value: NilClass, open_modal: TrueClass, path: String)"
