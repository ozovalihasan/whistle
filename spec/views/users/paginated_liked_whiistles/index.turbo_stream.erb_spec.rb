...
RSpec.describe 'users/paginated_liked_whiistles/index.turbo_stream' do
  describe 'renders the index(turbo_stream) view of Users::PaginatedLikedWhiistlesController' do
